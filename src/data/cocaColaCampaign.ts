...
export const projectTimelineRows = [
  ...
  { wbs: "4.1", name: "Create 3D asset", type: "Design", stage: "Queued", start: "18 Jun", end: "21 Jun", duration: "3 days", left: 53, width: 10, color: "gold", progress: "0%", owner: "Arthur", channel: "3D Banner", dueDate: "06/21", comments: 2, reference: "COCA-3D-BANNER", priority: "High", tags: ["Photoshop", "3D", "After Effects"], image: "https://images.unsplash.com/photo-1554866585-cd94860890b7?auto=format&fit=crop&w=220&q=80" },
