...
export const demoSteps: Array<{ id: DemoStep; label: string; verb: string }> = [
  ...
  { id: "project", label: "Plan", verb: "Plan" },
...
export const projectTimelineRows = [
  { wbs: "1", name: "Concept", type: "Phase", stage: "Approved", start: "03 Jun", end: "07 Jun", duration: "4 days", left: 2, width: 14, color: "green", progress: "100%", owner: "Rachel", channel: "Concept", dueDate: "06/07", comments: 1, reference: "COCA-CONCEPT" },
  { wbs: "1.1", name: "Define idea", type: "Task", stage: "Approved", start: "03 Jun", end: "05 Jun", duration: "2 days", left: 2, width: 7, color: "green", progress: "100%", owner: "Maya", channel: "Concept", dueDate: "06/05", comments: 1, reference: "COCA-DEFINE", priority: "Low", tags: ["Concept", "Strategy"] },
  { wbs: "1.2", name: "Quick client approval", type: "Approval", stage: "Approved", start: "06 Jun", end: "07 Jun", duration: "1 day", left: 9, width: 5, color: "green", progress: "100%", owner: "Sofia", channel: "Concept", dueDate: "06/07", comments: 1, reference: "COCA-APPROVAL", priority: "Medium", tags: ["Concept", "Stakeholder"] },
  { wbs: "2", name: "Website", type: "Phase", stage: "In progress", start: "08 Jun", end: "18 Jun", duration: "10 days", left: 18, width: 31, color: "blue", progress: "55%", owner: "Arthur", channel: "Website", dueDate: "06/18", comments: 2, reference: "COCA-WEBSITE", priority: "High", tags: ["Website"] },
  { wbs: "2.1", name: "Design landing page", type: "Design", stage: "In progress", start: "08 Jun", end: "12 Jun", duration: "4 days", left: 18, width: 14, color: "blue", progress: "70%", owner: "Arthur", channel: "Website", dueDate: "06/12", comments: 3, reference: "COCA-WEB-DESIGN", priority: "High", tags: ["UX", "Figma", "Web"], image: "https://images.unsplash.com/photo-1554866585-cd94860890b7?auto=format&fit=crop&w=220&q=80" },
  { wbs: "2.2", name: "Build page", type: "Build", stage: "In progress", start: "13 Jun", end: "18 Jun", duration: "5 days", left: 33, width: 16, color: "blue", progress: "35%", owner: "Arthur", channel: "Website", dueDate: "06/18", comments: 1, reference: "COCA-WEB-BUILD", priority: "High", tags: ["Webflow", "HTML"] },
  { wbs: "3", name: "Video", type: "Phase", stage: "Internal review", start: "16 Jun", end: "20 Jun", duration: "4 days", left: 46, width: 16, color: "cyan", progress: "30%", owner: "Daniel", channel: "Video", dueDate: "06/20", comments: 0, reference: "COCA-VIDEO" },
  { wbs: "3.1", name: "Edit 15s video", type: "Edit", stage: "Internal review", start: "16 Jun", end: "20 Jun", duration: "4 days", left: 46, width: 16, color: "cyan", progress: "30%", owner: "Daniel", channel: "Video", dueDate: "06/20", comments: 4, reference: "COCA-VIDEO-15", priority: "Medium", tags: ["Premiere", "Video"], image: "https://images.unsplash.com/photo-1554866585-cd94860890b7?auto=format&fit=crop&w=220&q=80" },
  { wbs: "4", name: "3D Banner", type: "Phase", stage: "Queued", start: "18 Jun", end: "21 Jun", duration: "3 days", left: 63, width: 12, color: "gold", progress: "0%", owner: "Arthur", channel: "3D Banner", dueDate: "06/21", comments: 0, reference: "COCA-3D" },
  { wbs: "4.1", name: "Create 3D asset", type: "Design", stage: "Queued", start: "18 Jun", end: "21 Jun", duration: "3 days", left: 63, width: 12, color: "gold", progress: "0%", owner: "Arthur", channel: "3D Banner", dueDate: "06/21", comments: 2, reference: "COCA-3D-BANNER", priority: "High", tags: ["Photoshop", "3D", "After Effects"], image: "https://images.unsplash.com/photo-1554866585-cd94860890b7?auto=format&fit=crop&w=220&q=80" },
  { wbs: "5", name: "Delivery", type: "Phase", stage: "Client approval", start: "22 Jun", end: "25 Jun", duration: "3 days", left: 81, width: 17, color: "green", progress: "0%", owner: "Rachel", channel: "Delivery", dueDate: "06/25", comments: 0, reference: "COCA-DEL" },
  { wbs: "5.1", name: "Final approval", type: "Approval", stage: "Client approval", start: "22 Jun", end: "24 Jun", duration: "2 days", left: 81, width: 10, color: "blue", progress: "", owner: "Rachel", channel: "Delivery", dueDate: "06/24", comments: 1, reference: "COCA-FINAL", priority: "High", tags: ["Review", "Stakeholder"] },
  { wbs: "5.2", name: "Deliver files", type: "Delivery", stage: "Ready for delivery", start: "25 Jun", end: "25 Jun", duration: "1 day", left: 93, width: 5, color: "green", progress: "", owner: "Rachel", channel: "Delivery", dueDate: "06/25", comments: 1, reference: "COCA-DELIVERY", priority: "Medium", tags: ["Export", "Handoff"] },
] as const;
